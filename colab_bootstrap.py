...
def bootstrap():
    ...
    try:
        ...
        # 將專案根目錄和 scripts 目錄都加入 sys.path
        project_path_str = str(project_path)
        scripts_path_str = str(project_path / "scripts")
        ...
        print(f"✅ 已將以下路徑加入 Python 搜尋路徑: \n   - {project_path_str}\n   - {scripts_path_str}")

        print("\n--- 步驟 4/4: 安裝與啟動 ---")
        # 修正 requirements.txt 的路徑
        ...
        if requirements_path.exists():
            ...
            print(f"⚠️  找不到依賴套件檔案: {requirements_path}，跳過安裝。")
