...
# ==============================================================================
# Phase 3: Colab 環境強制配置
# ==============================================================================
# [作戰藍圖 244-Z] 移除環境偵測，強制使用系統 Python。
# 這是 Colab 部署的標準最佳實踐，以避免虛擬環境與系統 Python 的衝突。
echof "Environment Forcing" "正在強制 Poetry 使用系統 Python (無虛擬環境)..." "\e[33m"
export POETRY_VIRTUALENVS_CREATE=false
echof "Environment Forcing" "環境變數 POETRY_VIRTUALENVS_CREATE 已永久設定為 false。" "\e[33m"
